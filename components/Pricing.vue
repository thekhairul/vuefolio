<template>
  <div class="flex flex-wrap -mx-2">
    <div class="w-1/4 px-2 mb-4 flex flex-col">
    ...
    <div v-for="(model, idx) in priceModels" :key="idx" class="w-1/4 px-2 mb-4">
      <div
        class="h-full p-4 flex flex-col items-center justify-center pricing-card shadow-lg rounded-lg bg-white"
      >
        <component :is="model.thumb" class="w-16 h-16"></component>
